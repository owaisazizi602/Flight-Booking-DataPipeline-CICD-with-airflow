...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_excercise_1")
    bq_project = Variable.get("bq_project", default_var="clever-muse-475619-j1")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "41929424403-compute@developer.gserviceaccount.com",
                "network_uri": "projects/clever-muse-475619-j1/global/networks/default",
                "subnetwork_uri": "projects/clever-muse-475619-j1/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="clever-muse-475619-j1",
        region="us-central1",
